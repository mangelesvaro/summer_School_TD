...
Como base del ejercicio se estudiará el incendio acaecido entre los días 7 y 10 de agosto de 1993 en la provincia de Granada, afectando a unas 7.000 ha, de las cuales unas 250 ha estaban localizadas en el interior del Parque Natural de la Sierra de Huétor. En ella se quemaron repoblaciones de *Pinus pinaster*, *Pinus halepensis*, *Pinus nigra* y en menor medida con *Pinus sylvestris* y *Populus* realizadas en la década de los años 40 del siglo pasado. Tras el incendio, han sido escasas las labores de reforestación desarrolladas en la zona. La más significativa se ejecutó a finales de 1996 y consistió en una siembra aérea de 16 especies de pinos y matorral con muy bajos resultados.  
...
Se va a emplear el producto que se refiere a los datos procedentes de Landsat 5 TM, satélite operativo en el periodo en el que ocurrió el incendio, con nivel de procesamiento 2. 

![](./Auxiliares/Coleccion.PNG) 
...
![](./Auxiliares/Resultados.PNG) 

Para decidir cuál representa mejor el momento anterior al incendio, es aconsejable visualizar las vistas previas. Para la imagen del 13 de marzo:  

![](./Auxiliares/Preview1.png) 

Y para la imagen de 29 de marzo:
...
![](./Auxiliares/Download_pre.PNG) 

![](./Auxiliares/Download.PNG) 
...
![](./Auxiliares/Fechas2.PNG) 

En este caso, obtenemos 4 imágenes
...
En este caso, la imagen más apropiada para el estudio es la del 23 de octubre, ya que la nubosidad en el resto impide el estudio en la zona del incendio.
...
#### 2.1. Preparación de los datos en el entorno RStudio 
